...
use crate::game_loop::party::{REQUEST_TIMEOUT_TICKS, broadcast_to_party, install_request};
...
pub(crate) fn handle_request_ex_ask_join_mpcc(world: &mut World, client_id: u32, body: &[u8]) {
    ...
    let Some((_, target)) = crate::game_loop::party::find_player_by_name(world, &pkt.name) else {
        return;
    };
...
pub(crate) fn handle_request_ex_accept_join_mpcc(world: &mut World, client_id: u32, body: &[u8]) {
    ...
    crate::game_loop::party::clear_linked_request(world, answerer);
...
pub(crate) fn handle_request_ex_oust_from_mpcc(world: &mut World, client_id: u32, body: &[u8]) {
    ...
    let target = crate::game_loop::party::find_player_by_name(world, &pkt.name).map(|(_, oid)| oid);
    ...
    world
        ...
        .filter_map(|oid| {
            ...
            Some(MpccRoomMemberView {
                ...
                level: p.level,
                class_id: p.class_id,
                location: super::rooms::location_of(world, oid),
...
fn cc_room_info_packet(world: &World, room_id: i32) -> Option<Vec<u8>> {
    ...
    Some(server_packets::ex_mpcc_room_info(
        ...
        room.max_level,
        room.loot,
        super::rooms::location_of(world, room.leader),
        &room.title,
    ))
}
...
pub(crate) fn create_cc_room(world: &mut World, leader: i32, party_id: u32) {
    ...
    super::rooms::set_in_room_flag(world, leader, true);
    crate::game_loop::character::player_info::broadcast_user_info(world, leader);
...
pub(crate) fn cc_room_add_member(world: &mut World, room_id: i32, player: i32) -> bool {
    ...
    super::rooms::set_in_room_flag(world, player, true);
    crate::game_loop::character::player_info::broadcast_user_info(world, player);
    ...
    let (class_id, level) = world
        ...
        .unwrap_or_default();
    let location = super::rooms::location_of(world, player);
...
pub(crate) fn cc_room_remove_member(world: &mut World, room_id: i32, player: i32, kicked: bool) {
    ...
    super::rooms::set_in_room_flag(world, player, false);
    crate::game_loop::character::player_info::broadcast_user_info(world, player);
...
fn cc_room_disband(world: &mut World, room_id: i32) {
    ...
    for oid in room.all_members() {
        ...
        super::rooms::set_in_room_flag(world, oid, false);
...
pub(crate) fn handle_request_ex_list_mpcc_waiting(world: &mut World, client_id: u32, body: &[u8]) {
    ...
    let ids = world
        ...
        .find_cc_rooms(pkt.location, pkt.level, |leader| {
            super::rooms::location_of(world, leader)
        });
    let total = ids.len();
    ...
    let rows: Vec<MpccRoomListView> = ids
        ...
        .filter_map(|id| {
            ...
            Some(MpccRoomListView {
                ...
                location: super::rooms::location_of(world, room.leader),
...
pub(crate) fn on_raid_attacked_loot_rights(world: &mut World, npc_oid: i32, attacker_oid: i32) {
    ...
    if world
        ...
        || !crate::game_loop::raid_curse::gives_raid_curse(world, npc_oid)
    {
        return;
    }
