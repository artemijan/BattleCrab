...
//! for such a player — [`helpers::client_for_player`](crate::game_loop::helpers::client_for_player)
...
pub(crate) fn can_enter_offline_mode(world: &World, object_id: i32) -> bool {
    ...
    let in_olympiad = world.olympiad.is_registered(object_id)
        ...
        || crate::game_loop::olympiad::is_observing(world, object_id);
...
pub(crate) fn enter_offline_mode(world: &mut World, client_id: u32) -> bool {
    ...
    crate::game_loop::party::on_player_leave_world(world, object_id);
    crate::game_loop::olympiad::unregister(world, object_id);
    ...
    crate::game_loop::servitor::on_owner_leave_world(world, object_id);
    crate::game_loop::skills::cubic::on_owner_leave_world(world, object_id);
    ...
    crate::game_loop::space::visibility::refresh_char_info(world, object_id);

    // Java `sitDown()`s the trader — an unattended shop sits behind its wares.
    crate::game_loop::character::sit_stand::sit_down(world, object_id);
    ...
    crate::game_loop::net::store_player_now(world, object_id); // `player.storeMe()`
...
pub(crate) fn remove_trader(world: &mut World, object_id: i32) {
    ...
    if was_offline {
        ...
        crate::game_loop::net::store_and_remove_player(world, object_id);
    }
}
...
pub(crate) fn handle_voiced_offline(world: &mut World, client_id: u32) {
    ...
    if crate::game_loop::helpers::instance_of(world, object_id) != 0
...
pub(crate) fn handle_exit_game_answer(world: &mut World, client_id: u32, yes: bool) -> bool {
    ...
    if !enter_offline_mode(world, client_id) {
        crate::game_loop::net::handle_logout(world, client_id);
    }
    true
}
