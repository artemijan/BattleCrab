...
//! AuthLogin to EnterWorld, the shortcut/macro and UI-settings panels, the
//! flood protector that rate-limits the lot, and the `probes` log that bounds
//! what an unrecognised request can write.
