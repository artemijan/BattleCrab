...
fn create_sub_pledge(
    ...
    if leader_id != 0 {
        ...
        crate::game_loop::character::player_info::broadcast_user_info(world, leader_id);
    }
}
...
pub(crate) fn handle_assign_subpledge_leader(
    ...
    crate::game_loop::character::player_info::broadcast_user_info(world, member.char_id);
    broadcast_clan_status(world, clan_id);
