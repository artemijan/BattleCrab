...
pub(crate) fn handle_request_action_use(world: &mut World, client_id: u32, body: &[u8]) {
    ...
    if crate::game_loop::bot_report::is_action_blocked(world, object_id, pkt.action_id) {
...
fn dispatch(
    ...
    match row.handler.as_str() {
        ...
        "None" => {}
        "SitStand" => crate::game_loop::sit_stand::handle_sit_stand(world, object_id),
...
fn private_store(world: &mut World, client_id: u32, option: i32) {
    ...
    match option {
        ...
        1 | 2 => crate::game_loop::private_store::open_manage(world, client_id),
        8 => crate::game_loop::private_store::open_manage_package(world, client_id),
        // BUY(3) / BUY_MANAGE(4)
        3 | 4 => crate::game_loop::private_store::open_manage_buy(world, client_id),
        // MANUFACTURE(5)
        5 => crate::game_loop::crafting::open_manage(world, client_id),
...
fn general_manufacture(world: &mut World, client_id: u32, object_id: i32) {
    ...
    crate::game_loop::crafting::open_manage(world, client_id);
}
