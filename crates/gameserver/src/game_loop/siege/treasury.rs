...
pub(crate) fn npc_tax_castle(world: &World, npc_oid: i32) -> Option<i32> {
    if crate::game_loop::helpers::instance_of(world, npc_oid) != 0 {
        return None;
    }
    let pos = world
        .objects
...
fn is_owned(world: &World, castle_id: i32) -> bool {
    crate::game_loop::siege::owner_clan_id_opt(world, castle_id).is_some()
}
...
pub(crate) fn handle_function_renew(
    ...
    let Some(owner_id) = crate::game_loop::siege::owner_clan_id_opt(world, castle_id) else {
...
pub(crate) fn door_upgrade_ratio(world: &World, door_id: i32) -> i32 {
    crate::game_loop::upkeep::global_vars::get_i64(world, &door_upgrade_key(door_id), 1).max(1)
        as i32
}
...
pub(crate) fn set_door_upgrade(world: &mut World, door_id: i32, ratio: i32) {
    crate::game_loop::upkeep::global_vars::set(world, &door_upgrade_key(door_id), ratio);
...
pub(crate) fn trap_upgrade_level(world: &World, castle_id: i32, tower_index: i32) -> i32 {
    crate::game_loop::upkeep::global_vars::get_i64(
        world,
        &trap_upgrade_key(castle_id, tower_index),
        0,
    ) as i32
}
...
pub(crate) fn set_trap_upgrade(world: &mut World, castle_id: i32, tower_index: i32, level: i32) {
    crate::game_loop::upkeep::global_vars::set(
        world,
        &trap_upgrade_key(castle_id, tower_index),
        level,
    );
...
/// [`crate::game_loop::siege::oust_all_players`], filtered by clan.
pub(crate) fn banish_foreigners(world: &mut World, castle_id: i32) {
    let owner = crate::game_loop::siege::owner_clan_id_opt(world, castle_id).unwrap_or(0);
