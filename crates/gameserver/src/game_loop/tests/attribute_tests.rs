...
fn attribute_bonus_curve_and_caps() {
    ...
    let weak = crate::model::formulas::calc_effect_land_rate(40, 50, 0, 40, 1.0, 1.2, 1.0);
    let strong = crate::model::formulas::calc_effect_land_rate(40, 50, 0, 40, 1.0, 0.8, 1.0);
    assert!(weak > strong);
}
