...
fn siege_start_evicts_non_owners_to_town() {
    ...
    world.clans.insert(
        ...
        Clan {
            ...
            reputation_score: 0,
            castle_id: 3,
            members: vec![ClanMember { char_id: 9002, name: "P9002".into(), level: 40, class_id: 0, sex: 0, race: 0 , power_grade: 5, title: String::new() }],
...
fn siege_capture_transfers_ownership_and_endsiege_declares_victor() {
    ...
    let clan = |id: i32, name: &str, leader: i32, castle: i32| Clan {
        ...
        reputation_score: 0,
        castle_id: castle,
        members: vec![ClanMember { char_id: leader, name: format!("P{leader}"), level: 40, class_id: 0, sex: 0, race: 0, power_grade: 1, title: String::new() }],
        skills: Default::default(),
        warehouse: Default::default(),
        char_penalty_expiry_time: 0,
        dissolving_expiry_time: 0,
...
fn siege_artifact_capture_seizes_the_castle_for_the_attacker() {
    ...
    world.clans.insert(
        ...
        Clan {
            ...
            reputation_score: 0,
            castle_id: 0,
            members: vec![ClanMember { char_id: 8003, name: "P8003".into(), level: 40, class_id: 0, sex: 0, race: 0 , power_grade: 5, title: String::new() }],
            skills: Default::default(),
            warehouse: Default::default(),
            char_penalty_expiry_time: 0,
            dissolving_expiry_time: 0,
...
fn siege_defender_respawns_at_castle_on_to_castle() {
    ...
    world.clans.insert(
        ...
        Clan {
            ...
            reputation_score: 0,
            castle_id: 3,
            members: vec![ClanMember { char_id: 3001, name: "P3001".into(), level: 40, class_id: 0, sex: 0, race: 0 , power_grade: 5, title: String::new() }],
            skills: Default::default(),
            warehouse: Default::default(),
            char_penalty_expiry_time: 0,
            dissolving_expiry_time: 0,
...
fn attacker_clan(world: &mut World, player_oid: i32) {
    ...
    world.clans.insert(
        ...
        Clan {
            ...
            reputation_score: 0,
            castle_id: 0,
            members: vec![ClanMember { char_id: player_oid, name: "P".into(), level: 40, class_id: 0, sex: 0, race: 0 , power_grade: 5, title: String::new() }],
            skills: Default::default(),
            warehouse: Default::default(),
            char_penalty_expiry_time: 0,
            dissolving_expiry_time: 0,
