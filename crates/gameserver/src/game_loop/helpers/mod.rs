...
pub(crate) use lookup::{
    ...
    get_others_in_matching_room, instance_of, is_chest, is_creature, is_gm, is_playable,
    is_raid_npc, level_of, lvl_of_npc, maybe_object_name, npc_id_of, npc_name_or_empty,
    npc_template, npc_template_name, nth_arg, object_name, player, player_name,
