...
pub(crate) fn on_core_spawned(world: &mut World, core_oid: i32) {
    ...
    let first_attacked =
        crate::game_loop::upkeep::global_vars::get_bool(world, CORE_ATTACKED_VAR, false);
    world
        .objects
...
pub(crate) fn on_core_attacked(world: &mut World, core_oid: i32) {
    ...
    crate::game_loop::upkeep::global_vars::set(world, CORE_ATTACKED_VAR, true);
...
pub(crate) fn on_core_killed(world: &mut World) {
    ...
    crate::game_loop::upkeep::global_vars::set(world, CORE_ATTACKED_VAR, false);
