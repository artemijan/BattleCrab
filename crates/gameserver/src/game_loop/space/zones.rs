...
use crate::game_loop::helpers::{send_sm_bare_to_player, send_to_player};
...
pub(crate) fn revalidate_zone(world: &mut World, object_id: i32, force: bool) {
    ...
    if (old_mask ^ new_mask) & water_bit != 0 {
        ...
        if swimming {
            ...
            if cant_swim {
                crate::game_loop::admin::transforms::remove_transform(world, object_id);
            } else {
    ...
    if world.cfg.general.allow_water {
        crate::game_loop::space::water::check_water_state(world, object_id);
    }
    ...
    if swamp_changed {
        ...
        crate::game_loop::helpers::recalculate_player_stats(world, object_id);
        crate::game_loop::character::player_info::broadcast_user_info(world, object_id);
    }
    ...
    if hq != flags.tvt_hq_zone {
        ...
        crate::game_loop::events::tvt::on_hq_zone_change(world, object_id, flags.tvt_hq_zone, hq);
    }
    ...
    let fishing_avail = crate::game_loop::activities::fishing::fishing_available(world, object_id);
    ...
    crate::game_loop::moderation::punishment::enforce_jail_keep_in(world, object_id);
}
