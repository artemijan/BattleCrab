...
/// transitions from [`revalidate_zone`](crate::game_loop::space::zones::revalidate_zone).
...
fn cast_line(world: &mut World, player: i32) {
    ...
    if !is_charged_fish_shot(world, player) {
        crate::game_loop::items::recharge_shots(world, player, false, false, true);
    }
