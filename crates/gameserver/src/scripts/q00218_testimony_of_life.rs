...
fn gather(ctx: &mut QuestCtx, list: i32, own: i32, amount: i64, cap: i64, others: &[(i32, i64)], cond: i32) {
...
impl QuestScript for Q00218TestimonyOfLife {
    ...
    fn on_kill(&self, ctx: &mut QuestCtx) {
        ...
        match ctx.npc_id {
            ...
            HARPY => gather(ctx, ADONIUS_LIST, HARPYS_DOWN, 4, 20, &[(SPIDER_ICHOR, 20)], 10),
            MARSH_SPIDER => gather(ctx, ADONIUS_LIST, SPIDER_ICHOR, 4, 20, &[(HARPYS_DOWN, 20)], 10),
