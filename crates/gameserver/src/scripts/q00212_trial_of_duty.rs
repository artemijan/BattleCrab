...
fn flag(ctx: &QuestCtx) -> i32 {
    ctx.get_var("flag").and_then(|s| s.parse().ok()).unwrap_or(0)
}
    ...
    fn on_talk(&self, ctx: &mut QuestCtx) -> Option<String> {
        ...
        match ctx.npc_id {
            ...
            SIR_ARON_TANFORD => match memo {
                ...
                2 if ctx.quest_items_count(OLD_KNIGHTS_SWORD) > 0 => Some("30653-02.html".to_string()),
            ...
            SIR_KIEL_NIGHTHAWK => match memo {
                ...
                6 if ctx.quest_items_count(MIRROR_OF_ORPIC) > 0 => Some("30654-04.html".to_string()),
            ...
            ISAEL_SILVERSHADOW => match memo {
                ...
                10 if ctx.quest_items_count(TEAR_OF_LOYALTY) > 0 => Some("30655-05.html".to_string()),
                _ => Some(ctx.no_quest_html()),
            },
            DUSTIN => match memo {
                10 if ctx.quest_items_count(TEAR_OF_LOYALTY) > 0 => Some("30116-01.html".to_string()),
                11 => {
                    if ctx.quest_items_count(ATHEBALDTS_SKULL) == 0
                ...
                12 if ctx.quest_items_count(SAINTS_ASHES_URN) > 0 => Some("30116-09.html".to_string()),
                ...
                14 if ctx.quest_items_count(LETTER_OF_DUSTIN) > 0 => Some("30116-10.html".to_string()),
                _ => Some(ctx.no_quest_html()),
            },
            SIR_COLLIN_WINDAWOOD => match memo {
                ...
                13 if ctx.quest_items_count(LETTER_OF_WINDAWOOD) > 0 => Some("30311-02.html".to_string()),
                _ => Some(ctx.no_quest_html()),
            },
            _ => Some(ctx.no_quest_html()),
        }
