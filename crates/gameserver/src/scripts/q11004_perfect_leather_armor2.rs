//! Perfect Leather Armor2 (11004) — `quests/Q11004_PerfectLeatherArmor2`.
//!
...
//!
//! Gated on Q11003_PerfectLeatherArmor1 — `addCondCompletedQuest`, checked after the
//! level and race pair.
...
pub const QUEST: Chain = Chain {
    id: 11004,
    name: "Q11004_PerfectLeatherArmor2",
    html_dir: "quests/Q11004_PerfectLeatherArmor2",
    start_npcs: &[30001],
    talk_npcs: &[30001],
    kill_npcs: &[20103, 20106, 20108, 20110, 20113, 20115],
    quest_items: &[90211, 90212, 90213],
    levels: (15, 20),
    race: super::newbie_chain::HUMAN,
    requires: Some(("Q11003_PerfectLeatherArmor1", "30001-06.html")),
    start_event: "30001-02.htm",
    start_brief: Some((2, 90211, 1803498)),
    ...
    rewards: &[
        Reward {
            event: "reward1",
            cond: 4,
            take: &[(90211, 1), (90212, 25), (90213, 20)],
