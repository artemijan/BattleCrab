...
CREATE INDEX IF NOT EXISTS idx_charId_classIndex ON character_skills (charId, class_index);

-- UPDATE_CHARACTER_SKILL_LEVEL, ADD_NEW_SKILLS, DELETE_SKILL_FROM_CHAR
CREATE INDEX IF NOT EXISTS idx_skillId_charId_classIndex ON character_skills (skill_id, charId, class_index);
