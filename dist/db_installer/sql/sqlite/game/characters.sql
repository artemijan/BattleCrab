...
-- Common
CREATE INDEX IF NOT EXISTS idx_charId ON characters (charId);
CREATE INDEX IF NOT EXISTS idx_char_name ON characters (char_name);
CREATE INDEX IF NOT EXISTS idx_account_name ON characters (account_name);

-- CharSelectionInfo
CREATE INDEX IF NOT EXISTS idx_accountName_createDate ON characters (account_name, createDate);

-- TaskBirthday
CREATE INDEX IF NOT EXISTS idx_createDate ON characters (createDate);
