...
CREATE INDEX IF NOT EXISTS idx_charId_classIndex ON character_subclasses (charId, class_index);

-- CharSelectionInfo
CREATE INDEX IF NOT EXISTS idx_charId_classId ON character_subclasses (charId, class_id);
