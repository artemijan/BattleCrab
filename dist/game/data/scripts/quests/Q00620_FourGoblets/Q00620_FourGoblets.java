...
public class Q00620_FourGoblets extends Quest {
  ...
  public String onEvent(String event, Npc npc, Player player) {
    ...
    switch (event) {
      ...
      case "19": {
        //take an item and check if this action was successful
        if (!takeItems(player, SEALED_BOX, 1)) {
      ...
      case "6881", "6883", "6885", "6887", "7580", "6891", "6893", "6895", "6897", "6899" : {
        if (takeItems(player, RELIC, 1000)) {
