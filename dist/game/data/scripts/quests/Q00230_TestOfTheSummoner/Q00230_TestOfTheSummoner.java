...
public class Q00230_TestOfTheSummoner extends Quest
{
    ...
    private record MonsterData(int _crystalOfInprogress, int _crystalOfVictory, NpcStringId _npcStringId) {

        private int getCrystalOfInprogress() {
            return _crystalOfInprogress;
        }

        private int getCrystalOfVictory() {
            return _crystalOfVictory;
        }

        private NpcStringId getNpcStringId() {
            return _npcStringId;
        }
    }
}
