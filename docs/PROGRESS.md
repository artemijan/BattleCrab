...
| Game  | G15 Economy & item actions                                  | 🚧 `RequestDestroyItem` + **ground items** (drop/pickup/visibility/auto-loot=false/decay) landed; warehouse/stores/trade/enchant/augment/crystallize pending (each a focused sub-milestone) |
