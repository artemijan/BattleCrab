...
| Game  | G15 Economy & item actions                                  | 🚧 `RequestDestroyItem` + **ground items** (drop/pickup/visibility/auto-loot=false/decay) + **personal warehouse** (deposit/withdraw + persistence) landed; clan-wh/stores/trade/enchant/augment/crystallize pending |
