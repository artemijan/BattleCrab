...
not break out. Alongside them sit **6 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 149.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 149 are
