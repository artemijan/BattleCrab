...
not break out. Alongside them sit **7 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 150.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 150 are
