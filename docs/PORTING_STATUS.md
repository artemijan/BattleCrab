...
not break out. Alongside them sit **9 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 152.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 152 are
