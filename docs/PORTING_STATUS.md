...
not break out. Alongside them sit **19 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 162.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 162 are
