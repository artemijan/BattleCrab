...
not break out. Alongside them sit **17 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 160.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 160 are
