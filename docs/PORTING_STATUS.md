...
not break out. Alongside them sit **21 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 164.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 164 are
