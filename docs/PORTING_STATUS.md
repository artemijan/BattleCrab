...
not break out. Alongside them sit **27 topic-tagged** markers (`pets`, `manor`,
`soul-crystal`, `radar`, `dead`, …) which belong to no milestone at all.

**Total recorded gaps: 170.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 170 are
