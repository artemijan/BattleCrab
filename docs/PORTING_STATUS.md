...
not break out. Alongside them sit **8 topic-tagged** markers (`pets`,
...
**Total recorded gaps: 151.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 151 are
