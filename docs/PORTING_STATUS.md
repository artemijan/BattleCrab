...
not break out. Alongside them sit **30 topic-tagged** markers (`pets`, `manor`,
`soul-crystal`, `radar`, `dead`, …) which belong to no milestone at all.

**Total recorded gaps: 173.** Enumerated in [DEFERRALS.md](DEFERRALS.md) and
...
that file's seventh pass. Because every milestone row here is ✅, these 173 are
